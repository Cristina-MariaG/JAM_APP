...
# python3.10 /back/manage.py inspectdb > back_app/models.py

# python3.10 /back/manage.py migrate


# python3.10 /back/manage.py makemigrations

python3.10 /back/manage.py migrate --run-syncdb

python3.10 /back/manage.py loaddata initial-data.json
